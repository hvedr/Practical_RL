...
ymd_main_seg   = '2015-01-01' #get_last_main_seg_calc_date(cursor)  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!###!#!#!#!#!

print 'ymd_loaded = ' + str(ymd_loaded)
print 'ymd_calculated = ' + str(ymd_calculated)
print 'ymd_main_seg = ' + str(ymd_main_seg)
sys.stdout.flush()
...
while (ymd_calculated >= ymd_loaded) | (ymd_calculated >= ymd_main_seg):  
    ...
    if cnt > 70:
        ...
        exit(1)
    print('{}.Waiting for visits later than {}. Sleeping. ymd_main_seg {}. ymd_calculated {}.'.format(datetime.datetime.now(), ymd_loaded, ymd_main_seg, ymd_calculated))
    sys.stdout.flush()
    time.sleep(1000)
    ymd_loaded = get_last_raw_data_date(cursor)
